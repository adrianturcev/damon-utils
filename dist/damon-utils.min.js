...
`&&o!=="\r"&&o!==`\r
`&&(o=`
`);var L=0,F=!1;this.parse=function(k,$,S){if(typeof k!="string")throw new Error("Input must be a string");var ne=k.length,P=a.length,ie=o.length,G=A.length,K=g(T),W=[],Z=[],B=[],Q=L=0;if(!k)return ce();if(D||D!==!1&&k.indexOf(O)===-1){for(var oe=k.split(o),te=0;te<oe.length;te++){if(B=oe[te],L+=B.length,te!==oe.length-1)L+=o.length;else if(S)return ce();if(!A||B.substring(0,G)!==A){if(K){if(W=[],re(B.split(a)),Ee(),F)return ce()}else re(B.split(a));if(E&&E<=te)return W=W.slice(0,E),ce(!0)}}return ce()}for(var q=k.indexOf(a,L),U=k.indexOf(o,L),se=new RegExp(_(v)+_(O),"g"),Y=k.indexOf(O,L);;)if(k[L]===O)for(Y=L,L++;;){if((Y=k.indexOf(O,Y+1))===-1)return S||Z.push({type:"Quotes",code:"MissingQuotes",message:"Quoted field unterminated",row:W.length,index:L}),me();if(Y===ne-1)return me(k.substring(L,Y).replace(se,O));if(O===v&&k[Y+1]===v)Y++;else if(O===v||Y===0||k[Y-1]!==v){q!==-1&&q<Y+1&&(q=k.indexOf(a,Y+1));var ee=we((U=U!==-1&&U<Y+1?k.indexOf(o,Y+1):U)===-1?q:Math.min(q,U));if(k.substr(Y+1+ee,P)===a){B.push(k.substring(L,Y).replace(se,O)),k[L=Y+1+ee+P]!==O&&(Y=k.indexOf(O,L)),q=k.indexOf(a,L),U=k.indexOf(o,L);break}if(ee=we(U),k.substring(Y+1+ee,Y+1+ee+ie)===o){if(B.push(k.substring(L,Y).replace(se,O)),Me(Y+1+ee+ie),q=k.indexOf(a,L),Y=k.indexOf(O,L),K&&(Ee(),F))return ce();if(E&&W.length>=E)return ce(!0);break}Z.push({type:"Quotes",code:"InvalidQuotes",message:"Trailing quote on quoted field is malformed",row:W.length,index:L}),Y++}}else if(A&&B.length===0&&k.substring(L,L+G)===A){if(U===-1)return ce();L=U+ie,U=k.indexOf(o,L),q=k.indexOf(a,L)}else if(q!==-1&&(q<U||U===-1))B.push(k.substring(L,q)),L=q+P,q=k.indexOf(a,L);else{if(U===-1)break;if(B.push(k.substring(L,U)),Me(U+ie),K&&(Ee(),F))return ce();if(E&&W.length>=E)return ce(!0)}return me();function re(le){W.push(le),Q=L}function we(le){var fe=0;return fe=le!==-1&&(le=k.substring(Y+1,le))&&le.trim()===""?le.length:fe}function me(le){return S||(le===void 0&&(le=k.substring(L)),B.push(le),L=ne,re(B),K&&Ee()),ce()}function Me(le){L=le,re(B),B=[],U=k.indexOf(o,L)}function ce(le){if(s.header&&!$&&W.length&&!X){var fe=W[0],he=Object.create(null),Ce=new Set(fe);let Fe=!1;for(let Se=0;Se<fe.length;Se++){let _e=fe[Se];if(he[_e=g(s.transformHeader)?s.transformHeader(_e,Se):_e]){let Le,Ue=he[_e];for(;Le=_e+"_"+Ue,Ue++,Ce.has(Le););Ce.add(Le),fe[Se]=Le,he[_e]++,Fe=!0,(j=j===null?{}:j)[Le]=_e}else he[_e]=1,fe[Se]=_e;Ce.add(_e)}Fe&&console.warn("Duplicate headers found and renamed."),X=!0}return{data:W,errors:Z,meta:{delimiter:a,linebreak:o,aborted:F,truncated:!!le,cursor:Q+($||0),renamedHeaders:j}}}function Ee(){T(ce()),W=[],Z=[]}},this.abort=function(){F=!0},this.getCharIndex=function(){return L}}function I(s){var a=s.data,o=f[a.workerId],A=!1;if(a.error)o.userError(a.error,a.file);else if(a.results&&a.results.data){var T={abort:function(){A=!0,b(a.workerId,{data:[],errors:[],meta:{aborted:!0}})},pause:w,resume:w};if(g(o.userStep)){for(var E=0;E<a.results.data.length&&(o.userStep({data:a.results.data[E],errors:a.results.errors,meta:a.results.meta},T),!A);E++);delete a.results}else g(o.userChunk)&&(o.userChunk(a.results,T,a.file),delete a.results)}a.finished&&!A&&b(a.workerId,a.results)}function b(s,a){var o=f[s];g(o.userComplete)&&o.userComplete(a),o.terminate(),delete f[s]}function w(){throw new Error("Not implemented.")}function N(s){if(typeof s!="object"||s===null)return s;var a,o=Array.isArray(s)?[]:{};for(a in s)o[a]=N(s[a]);return o}function y(s,a){return function(){s.apply(a,arguments)}}function g(s){return typeof s=="function"}return i.parse=function(s,a){var o=(a=a||{}).dynamicTyping||!1;if(g(o)&&(a.dynamicTypingFunction=o,o={}),a.dynamicTyping=o,a.transform=!!g(a.transform)&&a.transform,!a.worker||!i.WORKERS_SUPPORTED)return o=null,i.NODE_STREAM_INPUT,typeof s=="string"?(s=(A=>A.charCodeAt(0)!==65279?A:A.slice(1))(s),o=new(a.download?c:l)(a)):s.readable===!0&&g(s.read)&&g(s.on)?o=new d(a):(r.File&&s instanceof File||s instanceof Object)&&(o=new h(a)),o.stream(s);(o=(()=>{var A;return!!i.WORKERS_SUPPORTED&&(A=(()=>{var T=r.URL||r.webkitURL||null,E=z.toString();return i.BLOB_URL||(i.BLOB_URL=T.createObjectURL(new Blob(["var global = (function() { if (typeof self !== 'undefined') { return self; } if (typeof window !== 'undefined') { return window; } if (typeof global !== 'undefined') { return global; } return {}; })(); global.IS_PAPA_WORKER=true; ","(",E,")();"],{type:"text/javascript"})))})(),(A=new r.Worker(A)).onmessage=I,A.id=n++,f[A.id]=A)})()).userStep=a.step,o.userChunk=a.chunk,o.userComplete=a.complete,o.userError=a.error,a.step=g(a.step),a.chunk=g(a.chunk),a.complete=g(a.complete),a.error=g(a.error),delete a.worker,o.postMessage({input:s,config:a,workerId:o.id})},i.unparse=function(s,a){var o=!1,A=!0,T=",",E=`\r
`,D='"',j=D+D,X=!1,O=null,v=!1,L=((()=>{if(typeof a=="object"){if(typeof a.delimiter!="string"||i.BAD_DELIMITERS.filter(function($){return a.delimiter.indexOf($)!==-1}).length||(T=a.delimiter),typeof a.quotes!="boolean"&&typeof a.quotes!="function"&&!Array.isArray(a.quotes)||(o=a.quotes),typeof a.skipEmptyLines!="boolean"&&typeof a.skipEmptyLines!="string"||(X=a.skipEmptyLines),typeof a.newline=="string"&&(E=a.newline),typeof a.quoteChar=="string"&&(D=a.quoteChar),typeof a.header=="boolean"&&(A=a.header),Array.isArray(a.columns)){if(a.columns.length===0)throw new Error("Option columns is empty");O=a.columns}a.escapeChar!==void 0&&(j=a.escapeChar+D),a.escapeFormulae instanceof RegExp?v=a.escapeFormulae:typeof a.escapeFormulae=="boolean"&&a.escapeFormulae&&(v=/^[=+\-@\t\r].*$/)}})(),new RegExp(_(D),"g"));if(typeof s=="string"&&(s=JSON.parse(s)),Array.isArray(s)){if(!s.length||Array.isArray(s[0]))return F(null,s,X);if(typeof s[0]=="object")return F(O||Object.keys(s[0]),s,X)}else if(typeof s=="object")return typeof s.data=="string"&&(s.data=JSON.parse(s.data)),Array.isArray(s.data)&&(s.fields||(s.fields=s.meta&&s.meta.fields||O),s.fields||(s.fields=Array.isArray(s.data[0])?s.fields:typeof s.data[0]=="object"?Object.keys(s.data[0]):[]),Array.isArray(s.data[0])||typeof s.data[0]=="object"||(s.data=[s.data])),F(s.fields||[],s.data||[],X);throw new Error("Unable to serialize unrecognized input");function F($,S,ne){var P="",ie=(typeof $=="string"&&($=JSON.parse($)),typeof S=="string"&&(S=JSON.parse(S)),Array.isArray($)&&0<$.length),G=!Array.isArray(S[0]);if(ie&&A){for(var K=0;K<$.length;K++)0<K&&(P+=T),P+=k($[K],K);0<S.length&&(P+=E)}for(var W=0;W<S.length;W++){var Z=(ie?$:S[W]).length,B=!1,Q=ie?Object.keys(S[W]).length===0:S[W].length===0;if(ne&&!ie&&(B=ne==="greedy"?S[W].join("").trim()==="":S[W].length===1&&S[W][0].length===0),ne==="greedy"&&ie){for(var oe=[],te=0;te<Z;te++){var q=G?$[te]:te;oe.push(S[W][q])}B=oe.join("").trim()===""}if(!B){for(var U=0;U<Z;U++){0<U&&!Q&&(P+=T);var se=ie&&G?$[U]:U;P+=k(S[W][se],U)}W<S.length-1&&(!ne||0<Z&&!Q)&&(P+=E)}}return P}function k($,S){var ne,P;return $==null?"":$.constructor===Date?JSON.stringify($).slice(1,25):(P=!1,v&&typeof $=="string"&&v.test($)&&($="'"+$,P=!0),ne=$.toString().replace(L,j),(P=P||o===!0||typeof o=="function"&&o($,S)||Array.isArray(o)&&o[S]||((ie,G)=>{for(var K=0;K<G.length;K++)if(-1<ie.indexOf(G[K]))return!0;return!1})(ne,i.BAD_DELIMITERS)||-1<ne.indexOf(T)||ne.charAt(0)===" "||ne.charAt(ne.length-1)===" ")?D+ne+D:ne)}},i.RECORD_SEP="",i.UNIT_SEP="",i.BYTE_ORDER_MARK="\uFEFF",i.BAD_DELIMITERS=["\r",`
`,'"',i.BYTE_ORDER_MARK],i.WORKERS_SUPPORTED=!e&&!!r.Worker,i.NODE_STREAM_INPUT=1,i.LocalChunkSize=10485760,i.RemoteChunkSize=5242880,i.DefaultDelimiter=",",i.Parser=x,i.ParserHandle=C,i.NetworkStreamer=c,i.FileStreamer=h,i.StringStreamer=l,i.ReadableStreamStreamer=d,r.jQuery&&((m=r.jQuery).fn.parse=function(s){var a=s.config||{},o=[];return this.each(function(E){if(!(m(this).prop("tagName").toUpperCase()==="INPUT"&&m(this).attr("type").toLowerCase()==="file"&&r.FileReader)||!this.files||this.files.length===0)return!0;for(var D=0;D<this.files.length;D++)o.push({file:this.files[D],inputElem:this,instanceConfig:m.extend({},a)})}),A(),this;function A(){if(o.length===0)g(s.complete)&&s.complete();else{var E,D,j,X,O=o[0];if(g(s.before)){var v=s.before(O.file,O.inputElem);if(typeof v=="object"){if(v.action==="abort")return E="AbortError",D=O.file,j=O.inputElem,X=v.reason,void(g(s.error)&&s.error({name:E},D,j,X));if(v.action==="skip")return void T();typeof v.config=="object"&&(O.instanceConfig=m.extend(O.instanceConfig,v.config))}else if(v==="skip")return void T()}var L=O.instanceConfig.complete;O.instanceConfig.complete=function(F){g(L)&&L(F,O.file,O.inputElem),T()},i.parse(O.file,O.instanceConfig)}}function T(){o.splice(0,1),A()}}),t&&(r.onmessage=function(s){s=s.data,i.WORKER_ID===void 0&&s&&(i.WORKER_ID=s.workerId),typeof s.input=="string"?r.postMessage({workerId:i.WORKER_ID,results:i.parse(s.input,s.config),finished:!0}):(r.File&&s.input instanceof File||s.input instanceof Object)&&(s=i.parse(s.input,s.config))&&r.postMessage({workerId:i.WORKER_ID,results:s,finished:!0})}),(c.prototype=Object.create(p.prototype)).constructor=c,(h.prototype=Object.create(p.prototype)).constructor=h,(l.prototype=Object.create(l.prototype)).constructor=l,(d.prototype=Object.create(p.prototype)).constructor=d,i})});var Wt=Xe((gt,Gt)=>{(function(z,r){typeof define=="function"&&define.amd?define(r):typeof gt=="object"?Gt.exports=r():z.jsonLogic=r()})(gt,function(){"use strict";Array.isArray||(Array.isArray=function(e){return Object.prototype.toString.call(e)==="[object Array]"});function z(e){for(var t=[],f=0,n=e.length;f<n;f++)t.indexOf(e[f])===-1&&t.push(e[f]);return t}var r={},m={"==":function(e,t){return e==t},"===":function(e,t){return e===t},"!=":function(e,t){return e!=t},"!==":function(e,t){return e!==t},">":function(e,t){return e>t},">=":function(e,t){return e>=t},"<":function(e,t,f){return f===void 0?e<t:e<t&&t<f},"<=":function(e,t,f){return f===void 0?e<=t:e<=t&&t<=f},"!!":function(e){return r.truthy(e)},"!":function(e){return!r.truthy(e)},"%":function(e,t){return e%t},log:function(e){return console.log(e),e},in:function(e,t){return!t||typeof t.indexOf>"u"?!1:t.indexOf(e)!==-1},cat:function(){return Array.prototype.join.call(arguments,"")},substr:function(e,t,f){if(f<0){var n=String(e).substr(t);return n.substr(0,n.length+f)}return String(e).substr(t,f)},"+":function(){return Array.prototype.reduce.call(arguments,function(e,t){return parseFloat(e,10)+parseFloat(t,10)},0)},"*":function(){return Array.prototype.reduce.call(arguments,function(e,t){return parseFloat(e,10)*parseFloat(t,10)})},"-":function(e,t){return t===void 0?-e:e-t},"/":function(e,t){return e/t},min:function(){return Math.min.apply(this,arguments)},max:function(){return Math.max.apply(this,arguments)},merge:function(){return Array.prototype.reduce.call(arguments,function(e,t){return e.concat(t)},[])},var:function(e,t){var f=t===void 0?null:t,n=this;if(typeof e>"u"||e===""||e===null)return n;for(var i=String(e).split("."),p=0;p<i.length;p++)if(n==null||(n=n[i[p]],n===void 0))return f;return n},missing:function(){for(var e=[],t=Array.isArray(arguments[0])?arguments[0]:arguments,f=0;f<t.length;f++){var n=t[f],i=r.apply({var:n},this);(i===null||i==="")&&e.push(n)}return e},missing_some:function(e,t){var f=r.apply({missing:t},this);return t.length-f.length>=e?[]:f}};return r.is_logic=function(e){return typeof e=="object"&&e!==null&&!Array.isArray(e)&&Object.keys(e).length===1},r.truthy=function(e){return Array.isArray(e)&&e.length===0?!1:!!e},r.get_operator=function(e){return Object.keys(e)[0]},r.get_values=function(e){return e[r.get_operator(e)]},r.apply=function(e,t){if(Array.isArray(e))return e.map(function(_){return r.apply(_,t)});if(!r.is_logic(e))return e;var f=r.get_operator(e),n=e[f],i,p,c,h,l;if(Array.isArray(n)||(n=[n]),f==="if"||f=="?:"){for(i=0;i<n.length-1;i+=2)if(r.truthy(r.apply(n[i],t)))return r.apply(n[i+1],t);return n.length===i+1?r.apply(n[i],t):null}else if(f==="and"){for(i=0;i<n.length;i+=1)if(p=r.apply(n[i],t),!r.truthy(p))return p;return p}else if(f==="or"){for(i=0;i<n.length;i+=1)if(p=r.apply(n[i],t),r.truthy(p))return p;return p}else{if(f==="filter")return h=r.apply(n[0],t),c=n[1],Array.isArray(h)?h.filter(function(_){return r.truthy(r.apply(c,_))}):[];if(f==="map")return h=r.apply(n[0],t),c=n[1],Array.isArray(h)?h.map(function(_){return r.apply(c,_)}):[];if(f==="reduce")return h=r.apply(n[0],t),c=n[1],l=typeof n[2]<"u"?r.apply(n[2],t):null,Array.isArray(h)?h.reduce(function(_,x){return r.apply(c,{current:x,accumulator:_})},l):l;if(f==="all"){if(h=r.apply(n[0],t),c=n[1],!Array.isArray(h)||!h.length)return!1;for(i=0;i<h.length;i+=1)if(!r.truthy(r.apply(c,h[i])))return!1;return!0}else if(f==="none"){if(h=r.apply(n[0],t),c=n[1],!Array.isArray(h)||!h.length)return!0;for(i=0;i<h.length;i+=1)if(r.truthy(r.apply(c,h[i])))return!1;return!0}else if(f==="some"){if(h=r.apply(n[0],t),c=n[1],!Array.isArray(h)||!h.length)return!1;for(i=0;i<h.length;i+=1)if(r.truthy(r.apply(c,h[i])))return!0;return!1}}if(n=n.map(function(_){return r.apply(_,t)}),m.hasOwnProperty(f)&&typeof m[f]=="function")return m[f].apply(t,n);if(f.indexOf(".")>0){var d=String(f).split("."),C=m;for(i=0;i<d.length;i++){if(!C.hasOwnProperty(d[i]))throw new Error("Unrecognized operation "+f+" (failed at "+d.slice(0,i+1).join(".")+")");C=C[d[i]]}return C.apply(t,n)}throw new Error("Unrecognized operation "+f)},r.uses_data=function(e){var t=[];if(r.is_logic(e)){var f=r.get_operator(e),n=e[f];Array.isArray(n)||(n=[n]),f==="var"?t.push(n[0]):n.forEach(function(i){t.push.apply(t,r.uses_data(i))})}return z(t)},r.add_operation=function(e,t){m[e]=t},r.rm_operation=function(e){delete m[e]},r.rule_like=function(e,t){if(t===e||t==="@")return!0;if(t==="number")return typeof e=="number";if(t==="string")return typeof e=="string";if(t==="array")return Array.isArray(e)&&!r.is_logic(e);if(r.is_logic(t)){if(r.is_logic(e)){var f=r.get_operator(t),n=r.get_operator(e);if(f==="@"||f===n)return r.rule_like(r.get_values(e,!1),r.get_values(t,!1))}return!1}if(Array.isArray(t))if(Array.isArray(e)){if(t.length!==e.length)return!1;for(var i=0;i<t.length;i+=1)if(!r.rule_like(e[i],t[i]))return!1;return!0}else return!1;return!1},r})});var Yt=Xe((Lr,Vt)=>{var V=Jt(),qt=jt(),At=Wt();Vt.exports=class{constructor(r){let m=this;m.damon=r,m.domPurify=V,m.websiteRegex=/^(https?:\/\/)?[-a-zA-Z0-9]*[a-zA-Z0-9]+(\.[-a-zA-Z0-9]*[a-zA-Z0-9]+)+/,m.httpRegex=/^https?:\/\//,m.pathRegex=/^\.*\//}damonToHtmlTable(r){let m=this;return m.mapToHtmlTable(m.damon.damonToMap(r,0,!0))}damonToSExpression(r){let m=this;return m.prefixedKeysMapToSExpression(m.damon.damonToMap(r,0,!0))}sExpressionToDamon(r){let m=this;return m.damon.mapToDamon(m.sExpressionToPrefixedKeysMap(r),!1,!0)}escape(r){return r.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;")}mapToHtmlList(r,m=!1,e=void 0){let t=this;try{t.damon.mapToJSON(r)}catch{throw new Error("Provided map value doesn't passes JSON.parse()")}var f=0,n=document.createElement("ul"),i;return e!==void 0&&(i=JSON.parse(e)),n.className="DAMON-List",p(r,n),n;function p(c,h,l=[]){if(typeof h!="object"||h==null||Array.isArray(h))throw new Error("Error List Item number "+f+": @param { {} } list");if(typeof c=="object"&&c!==null&&!Array.isArray(c)&&c instanceof Map&&c.constructor===Map){if(h.tagName=="UL")for(let[_,x]of c){let I=document.createElement("ul"),b=document.createElement("code"),w=document.createElement("span"),N=document.createElement("li");if(N.dataset.graphArbo=Array.from(c.keys()).indexOf(_),l.length>0&&(N.dataset.graphArbo=l.join("-")+"-"+Array.from(c.keys()).indexOf(_)),w.className="type-key",t.websiteRegex.test(_)||t.pathRegex.test(_)){let y=_;t.websiteRegex.test(_)&&!t.httpRegex.test(_)&&(y="https://"+_);let g=V.sanitize(`<a href="${y}"><span>${y}</span></a>`);w.innerHTML=g}else e!==void 0&&_ in i["@context"]?w.innerHTML=V.sanitize(`<a href="${i["@context"][_]["@id"]}"><span>${_}</span></a>`):w.textContent=_;if(typeof x=="object"&&x!==null)if(Array.isArray(x))if(c.damonInlineArrays!==void 0&&c.damonInlineArrays.indexOf(_)>-1){b.innerHTML=w.outerHTML+'<span class="operator">: </span>[';for(let y=0,g=x.length;y<g;y++){let s=document.createElement("span"),a=x[y];if(a===!0)s.textContent="true",s.className="type-boolean";else if(a===!1)s.textContent="false",s.className="type-boolean";else if(a===null)s.textContent="null",s.className="type-null";else if(Number.isFinite(a)&&!Number.isNaN(a))s.textContent=a+"",s.className="type-number";else{if(m)if(t.websiteRegex.test(a)||t.pathRegex.test(a)){let o=a;t.websiteRegex.test(a)&&!t.httpRegex.test(a)&&(o="https://"+a),s.innerHTML=V.sanitize(`<a href="${o}">"${o}"</a>`)}else s.innerHTML=`"${a}"`;else if(t.websiteRegex.test(a)||t.pathRegex.test(a)){let o=a;!t.httpRegex.test(a)&&t.websiteRegex.test(a)&&(o="https://"+a),s.innerHTML=V.sanitize(`<a href="${o}">"${o}"</a>`)}else s.textContent=`"${a}"`;s.className="type-string"}y!==0&&(b.innerHTML+=", "),b.appendChild(s)}b.innerHTML+="]",N.appendChild(b),N.appendChild(I),h.appendChild(N)}else b.innerHTML=w.outerHTML+'<span class="operator">: </span>[]',N.appendChild(b),N.appendChild(I),h.appendChild(N),p(x,I,l.concat([Array.from(c.keys()).indexOf(_)]));else c.implicitMaps!==void 0&&c.implicitMaps.indexOf(_)>-1?b.innerHTML=w.outerHTML:b.innerHTML=w.outerHTML+'<span class="operator">: </span>{}',N.appendChild(b),N.appendChild(I),h.appendChild(N),p(x,I,l.concat([Array.from(c.keys()).indexOf(_)]));else{f++,b.innerHTML=w.outerHTML+'<span class="operator">: </span>';let y=document.createElement("span"),g=x;if(g===!0)y.textContent="true",y.className="type-boolean";else if(g===!1)y.textContent="false",y.className="type-boolean";else if(g===null)y.textContent="null",y.className="type-null";else if(Number.isFinite(g)&&!Number.isNaN(g))y.textContent=g+"",y.className="type-number";else{if(m)if(t.websiteRegex.test(g)||t.pathRegex.test(g)){let s=g;!t.httpRegex.test(g)&&t.websiteRegex.test(g)&&(s="https://"+g),y.innerHTML=V.sanitize(`<a href="${s}">"${s}"</a>`)}else y.innerHTML=`"${g}"`;else if(t.websiteRegex.test(g)||t.pathRegex.test(g)){let s=g;!t.httpRegex.test(g)&&t.websiteRegex.test(g)&&(s="https://"+g),y.innerHTML=V.sanitize(`<a href="${s}">"${s}"</a>`)}else y.textContent=`"${g}"`;y.className="type-string"}c.implicitNulls===void 0||c.implicitNulls.indexOf(_)==-1?b.appendChild(y):b.innerHTML=b.innerHTML.slice(0,-2),N.appendChild(b),h.appendChild(N)}}}else if(Array.isArray(c))for(var d=0,C=c.length;d<C;d++){let _=document.createElement("ul"),x=document.createElement("code"),I=document.createElement("li");if(I.dataset.graphArbo=d,l.length>0&&(I.dataset.graphArbo=l.join("-")+"-"+d),typeof c[d]=="object"&&c[d]!==null)if(Array.isArray(c[d]))if(c.damonInlineArrays!==void 0&&c.damonInlineArrays.indexOf(d)>-1){x.innerHTML+="[";for(let b=0,w=c[d].length;b<w;b++){let N=document.createElement("span"),y=c[d][b];if(y===!0)N.textContent="true",N.className="type-boolean";else if(y===!1)N.textContent="false",N.className="type-boolean";else if(y===null)N.textContent="null",N.className="type-null";else if(Number.isFinite(y)&&!Number.isNaN(y))N.textContent=y+"",N.className="type-number";else{if(m)if(t.websiteRegex.test(y)||t.pathRegex.test(y)){let g=y;!t.httpRegex.test(y)&&t.websiteRegex.test(y)&&(g="https://"+y),N.innerHTML=V.sanitize(`<a href="${g}">"${g}"</a>`)}else N.innerHTML=`"${y}"`;else if(t.websiteRegex.test(y)||t.pathRegex.test(y)){let g=y;!t.httpRegex.test(y)&&t.websiteRegex.test(y)&&(g="https://"+y),N.innerHTML=V.sanitize(`<a href="${g}">"${g}"</a>`)}else N.textContent=`"${y}"`;N.className="type-string"}b!==0&&(x.innerHTML+=", "),x.appendChild(N)}x.innerHTML+="]",I.appendChild(x),I.appendChild(_),h.appendChild(I)}else x.textContent="[]",I.appendChild(x),I.appendChild(_),h.appendChild(I),p(c[d],_,l.concat(d));else x.textContent="{}",I.appendChild(x),I.appendChild(_),h.appendChild(I),p(c[d],_,l.concat(d));else{f++;let b=c[d];if(b===!0)x.textContent="true",x.className="type-boolean";else if(b===!1)x.textContent="false",x.className="type-boolean";else if(b===null)x.textContent="null",x.className="type-null";else if(Number.isFinite(b)&&!Number.isNaN(b))x.textContent=b+"",x.className="type-number";else{if(m)if(t.websiteRegex.test(b)||t.pathRegex.test(b)){let w=b;!t.httpRegex.test(b)&&t.websiteRegex.test(b)&&(w="https://"+b),x.innerHTML=V.sanitize(`<a href="${w}">"${w}"</a>`)}else x.innerHTML=`"${b}"`;else if(t.websiteRegex.test(b)||t.pathRegex.test(b)){let w=b;!t.httpRegex.test(b)&&t.websiteRegex.test(b)&&(w="https://"+b),x.innerHTML=V.sanitize(`<a href="${w}">"${w}"</a>`)}else x.textContent=`"${b}"`;x.className="type-string"}I.appendChild(x),I.appendChild(_),h.appendChild(I)}}}}sliceIjsonKey(r){let m=r.match(/^[0-9]+-/);if(m[0]!==null)return r.slice(m[0].length);throw new Error(`Key "${r}" fails IJSON validation.`)}mapToHtmlTable(r,m=!1){let e=this;try{e.damon.mapToJSON(r)}catch{throw new Error("Provided value doesn't passes JSON.parse().")}var t=0,f=document.createElement("table"),n=document.createElement("thead"),i=document.createElement("tbody"),p=!1,c=0;if(f.className="DAMON-Table",typeof r!="object"||r==null||Array.isArray(r)||!(r instanceof Map)||r.constructor!==Map)throw new Error("Error: expected an Object value, saw otherwise.");for(let[h,l]of r){if(typeof l=="object"&&l!==null&&!Array.isArray(l)&&l instanceof Map&&l.constructor===Map)if(t==0){let d=Array.from(l.keys()).map(e.sliceIjsonKey),C=new Set(d);if(d.length!==C.size)throw new Error("Duplicate in headings.");let _=document.createElement("tr");c=l.length;for(let[x,I]of l){let b=e.sliceIjsonKey(x);if(I===null){let w=document.createElement("th");w.dataset.graphArbo=t+"-"+_.children.length,m?e.websiteRegex.test(b)||e.pathRegex.test(b)?w.innerHTML=V.sanitize(`<a href="${b}">${b}</a>`):w.innerHTML=`${b}`:e.websiteRegex.test(b)||e.pathRegex.test(b)?w.innerHTML=V.sanitize(`<a href="${b}">${b}</a>`):w.textContent=`${b}`,_.appendChild(w)}else throw new Error("Error row "+t+": expected implicit null property, saw otherwise.")}n.appendChild(_),p=!0}else{if(l.length!=c)throw new Error("Error row "+t+": cells total doesn't match the header's.");let d=document.createElement("tr");for(let[C,_]of l){let x=e.sliceIjsonKey(C);if(_===null){let I=document.createElement("td");I.dataset.graphArbo=t+"-"+d.children.length,m?e.websiteRegex.test(x)||e.pathRegex.test(x)?I.innerHTML=V.sanitize(`<a href="${x}">${x}</a>`):I.innerHTML=`${x}`:e.websiteRegex.test(x)||e.pathRegex.test(x)?I.innerHTML=V.sanitize(`<a href="${x}">${x}</a>`):I.textContent=`${x}`,d.appendChild(I)}else throw new Error("Error row "+t+": expected implicit null property, saw otherwise.")}i.appendChild(d)}else throw new Error("Error row "+t+": expected an Object value, saw otherwise.");t++}return p&&f.appendChild(n),f.appendChild(i),f}prefixedKeysMapToSExpression(r){let m=this;var e="";if(typeof r=="object"&&r!==null&&r instanceof Map&&r.constructor===Map)return e+=`[\r
`,t(r),e+="]",JSON.parse(e),e;return typeof r=="string"&&(r='"'+r+'"'),JSON.parse(r),r;function t(f,n=1){if(typeof f=="object"&&f!==null&&!Array.isArray(f)&&f instanceof Map&&f.constructor===Map){let c=-1;for(let[h,l]of f){c++;let d=m.sliceIjsonKey(h);if(typeof l=="object"&&l!==null)if(Array.isArray(l))l.length>0?(e+="    ".repeat(n)+`${JSON.stringify(d)}, [\r
`,t(l,n+1),e+="    ".repeat(n)+"]"):e+="    ".repeat(n)+`${JSON.stringify(d)}, []`;else if(Array.from(l.keys()).length>0){if(n==1)if(c==0)e="";else throw new Error("Multiple S-Expression roots");e+="    ".repeat(n)+`[${JSON.stringify(d)}, \r
`,t(l,n+1),n!=1&&(e+="    ".repeat(n)+"]")}else e+="    ".repeat(n)+`${JSON.stringify(d)}, []`;else{if(l===!0)throw new Error("Booleans require quotes");if(l===!1)throw new Error("Booleans require quotes");l===null?e+="    ".repeat(n)+`${JSON.stringify(d)}`:Number.isFinite(l)&&!Number.isNaN(l)?e+="    ".repeat(n)+`${JSON.stringify(d)}, `+l:e+="    ".repeat(n)+`${JSON.stringify(d)}, `+JSON.stringify(l)}let C=Array.from(f.keys())[Array.from(f.keys()).length-1];h!=C?e+=`,\r
`:e+=`\r
...
`:e+=`\r
`}}}sExpressionToPrefixedKeysMap(r){let m=this,e=new Map;return e.headless=!0,t(JSON.parse(r),e,0),e;function t(f,n,i){let p=new Map;n.set(i+"-"+f[0],p);for(let c=1,h=f.length;c<h;c++)if(Array.isArray(f[c]))t(f[c],p,c-1);else{let l=c-1+"-"+f[c];p.set(l,null)}}}prefixedKeysMapToMathJs(r){let m=this,e="";if(Array.isArray(r))return f(r),e.slice(0,-1);return typeof r=="object"&&r!==null&&r instanceof Map&&r.constructor===Map?(f(r),e.slice(0,-1)):(typeof r=="string"&&(r=JSON.stringify(r)),JSON.parse(r),r);function t(n){return n[0].toLowerCase()+n.slice(1)}function f(n,i=0){if(typeof n=="object"&&n!==null&&!Array.isArray(n)&&n instanceof Map&&n.constructor===Map)for(let[h,l]of n){let d=m.sliceIjsonKey(h);d=="Power"&&(d="Pow"),d=="e"&&(d="2.718281828459045"),d=="i"&&(d="sqrt(-1)"),d=="LN2"&&(d="0.6931471805599453"),d=="LN10"&&(d="2.302585092994046"),d=="LOG2E"&&(d="1.4426950408889634"),d=="LOG10E"&&(d="0.4342944819032518"),d=="phi"&&(d="1.618033988749895"),d=="pi"&&(d="3.141592653589793"),d=="SQRT1_2"&&(d="0.7071067811865476"),d=="SQRT2"&&(d="1.4142135623730951"),d=="tau"&&(d="6.283185307179586"),typeof l=="object"&&l!==null?Array.isArray(l)?l.length>0?(e+="    ".repeat(i)+`${JSON.stringify(t(d)).slice(1,-1)}(
`,f(l,i+1),e+="    ".repeat(i)+")"):e+="    ".repeat(i)+`${JSON.stringify(t(d)).slice(1,-1)}()`:Array.from(l.keys()).length>0?(e+="    ".repeat(i)+`${JSON.stringify(t(d)).slice(1,-1)}(
`,f(l,i+1),e+="    ".repeat(i)+")"):e+="    ".repeat(i)+`${JSON.stringify(t(d)).slice(1,-1)}()`:l===!0?e+="    ".repeat(i)+`${JSON.stringify(t(d)).slice(1,-1)}(true)`:l===!1?e+="    ".repeat(i)+`${JSON.stringify(t(d)).slice(1,-1)}(false)`:l===null?e+="    ".repeat(i)+`${JSON.stringify(t(d)).slice(1,-1)}`:Number.isFinite(l)&&!Number.isNaN(l)?e+="    ".repeat(i)+`${JSON.stringify(t(d)).slice(1,-1)}(`+l+")":e+="    ".repeat(i)+`${JSON.stringify(t(d)).slice(1,-1)}(`+JSON.stringify(l)+")";let C=Array.from(n.keys())[Array.from(n.keys()).length-1];h!=C?e+=`,
`:e+=`
